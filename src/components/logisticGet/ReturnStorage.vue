...
<script>
  ...
  let columns = 3;
  let defaultValues = {record_state:'0',record_type:'refund_inbound',tax_rate:'17',is_payoff:'0',record_time:(new Date()).format('yyyy-MM-dd hh:mm:ss'),
  ...
  let detailRules = {
    ...
    purchase_price : [{ rule: 'max', value:'100000000' ,message: '数额超过限度'}],
  ...
  export default{
    ...
    methods: {
      ...
      getAllModels(){
        // hy add 只取指定的入库类型
        this.filters.record_type  = "refund_inbound";
