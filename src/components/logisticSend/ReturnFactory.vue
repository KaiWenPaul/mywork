...
<script>
  ...
  let columns = 3;
  let defaultValues = {
    record_type:'return_factory', record_state:'0', payment_state:"0",tax_rate:'17',financial_processing_state:"0",rate:"1",after_amount:"0",record_time:(new Date()).format('yyyy-MM-dd hh:mm:ss'),account_id:window.sessionStorage.getItem('account_id'),account_name:window.sessionStorage.getItem('account_name')
  ...
  export default{
    ...
    methods: {
      ...
      getAllModels(){
        // hy add 只取指定的出库类型
        this.filters.record_type  = "return_factory";
